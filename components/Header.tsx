...
const Header: React.FC<HeaderProps> = ({ title, primaryAction, secondaryActions, darkMode, search }) => {
  ...
  return (
    <header className="flex items-center justify-end px-6 py-2 border-b border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 flex-shrink-0 gap-4">
